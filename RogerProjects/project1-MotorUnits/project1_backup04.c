...
double setpoint_filter(Robot* roger, double time)
{
  ...
  if (roger->environment == ARENA) {
    ...
    x_maxL = 0.0 - roger_reach;
    x_minR = 0.0 + roger_reach;
    x_maxR = MAX_X - roger_reach;
    y_maxA = MAX_Y - roger_reach;
    y_minA = MIN_Y + roger_reach;
  ...
  if (roger->environment == ARENA) {
    if (side == LEFT) {
      // if (Larm_x > x_maxL || Larm_x < x_minL || Rarm_x > x_maxL || Rarm_x < x_minL) {
      //   printf("Cross the line\n");
      //   roger->arm_setpoint[LEFT][0] = roger->arm_theta[LEFT][0];
      //   roger->arm_setpoint[LEFT][1] = roger->arm_theta[LEFT][1] - arm_offset;
      //   roger->arm_setpoint[RIGHT][0] = roger->arm_theta[RIGHT][0];
      //   roger->arm_setpoint[RIGHT][1] = roger->arm_theta[RIGHT][1] + arm_offset;
      // }
    ...
    if (side == RIGHT) {
      // if (Larm_x > x_maxR || Larm_x < x_minR || Rarm_x > x_maxR || Rarm_x < x_minR) {
      //   printf("Cross the line\n");
      //   roger->arm_setpoint[LEFT][0] = roger->arm_theta[LEFT][0];
      //   roger->arm_setpoint[LEFT][1] = roger->arm_theta[LEFT][1] - arm_offset;
      //   roger->arm_setpoint[RIGHT][0] = roger->arm_theta[RIGHT][0];
