...
int RogerArmMove(Robot* roger, double time)
{
	...
	// } else {
	// 	roger->arm_setpoint[LEFT][0] = recommended_setpoints[P7_PUNCH].arm[LEFT][0];
	// 	roger->arm_setpoint[LEFT][1] = recommended_setpoints[P7_PUNCH].arm[LEFT][1];
	// 	roger->arm_setpoint[RIGHT][0] = recommended_setpoints[P7_PUNCH].arm[RIGHT][0];
	// 	roger->arm_setpoint[RIGHT][1] = recommended_setpoints[P7_PUNCH].arm[RIGHT][1];
	// }
	return TRUE;
}
