...
#define RS_SEARCH_TRACK_CHASE_PUNCH_RETREAT 16
...
{
	stereo_observation(roger, &obs);
	if ( (rec_setp[RS_HOME].base[X] < 0.0 && obs.pos[X] > 0.0) || (rec_setp[RS_HOME].base[Y] > 0.0 && obs.pos[X] < 0.0) ) {
		return NO_REFERENCE;
	}
...
int TURN90_SAMPLE_BACKFORTH_BLOCK(Robot* roger, double time)
{
	...
	switch (state) {
		...
		case 1: // NO_REFERENCE - 	TRANSIENT
		case 2: // NO_REFERENCE - 	CONVERGED
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].eye[LEFT] = rec_setp[RS_SEARCH_TRACK].eye[LEFT];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].eye[RIGHT] = rec_setp[RS_SEARCH_TRACK].eye[RIGHT];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].base[THETA] = rec_setp[RS_SEARCH_TRACK].base[THETA];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].base[X] = rec_setp[RS_SEARCH_TRACK].base[X];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].base[Y] =	rec_setp[RS_SEARCH_TRACK].base[Y];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[LEFT][0] = rec_setp[RS_SEARCH_TRACK].arm[LEFT][0];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[LEFT][1] = rec_setp[RS_SEARCH_TRACK].arm[LEFT][1];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[RIGHT][0] = rec_setp[RS_SEARCH_TRACK].arm[RIGHT][0];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[RIGHT][1] = rec_setp[RS_SEARCH_TRACK].arm[RIGHT][1];
			return_state = NO_REFERENCE;
			break;
		case 3: // TRANSIENT - 			NO_REFERENCE
		case 4: // TRANSIENT - 			TRANSIENT
		case 5: // TRANSIENT - 			CONVERGED
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].eye[LEFT] = rec_setp[RS_TURN90].eye[LEFT];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].eye[RIGHT] = rec_setp[RS_TURN90].eye[RIGHT];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].base[THETA] = rec_setp[RS_TURN90].base[THETA];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].base[X] = rec_setp[RS_TURN90].base[X];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].base[Y] =	rec_setp[RS_TURN90].base[Y];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[LEFT][0] = rec_setp[RS_TURN90].arm[LEFT][0];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[LEFT][1] = rec_setp[RS_TURN90].arm[LEFT][1];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[RIGHT][0] = rec_setp[RS_TURN90].arm[RIGHT][0];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[RIGHT][1] = rec_setp[RS_TURN90].arm[RIGHT][1];
			return_state = TRANSIENT;
			break;
		case 6: // CONVERGED - 			NO_REFERENCE
		case 7: // CONVERGED - 			TRANSIENT
		case 8: // CONVERGED - 			CONVERGED
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].eye[LEFT] = rec_setp[RS_SAMPLE_BACKFORTH_BLOCK].eye[LEFT];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].eye[RIGHT] = rec_setp[RS_SAMPLE_BACKFORTH_BLOCK].eye[RIGHT];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].base[THETA] = rec_setp[RS_SAMPLE_BACKFORTH_BLOCK].base[THETA];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].base[X] = rec_setp[RS_SAMPLE_BACKFORTH_BLOCK].base[X];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].base[Y] =	rec_setp[RS_SAMPLE_BACKFORTH_BLOCK].base[Y];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[LEFT][0] = rec_setp[RS_SAMPLE_BACKFORTH_BLOCK].arm[LEFT][0];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[LEFT][1] = rec_setp[RS_SAMPLE_BACKFORTH_BLOCK].arm[LEFT][1];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[RIGHT][0] = rec_setp[RS_SAMPLE_BACKFORTH_BLOCK].arm[RIGHT][0];
			rec_setp[RS_TURN90_SAMPLE_BACKFORTH_BLOCK].arm[RIGHT][1] = rec_setp[RS_SAMPLE_BACKFORTH_BLOCK].arm[RIGHT][1];
			return_state = NO_REFERENCE;
			break;
		default:
			break;
